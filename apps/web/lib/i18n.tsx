...
const messages = {
  ...
  fa: {
    ...
    'home.card.runtime.description':
      'جلسه بسازید، وضعیت را بازیابی کنید و encounterها را مدیریت کنید.',
    'home.card.runtime.title': 'میز نبرد Runtime',
    'home.card.server.description': 'بک‌اند محلی را مستقیم بررسی کنید.',
    'home.card.server.title': 'وضعیت سرور',
    'home.eyebrow': 'Runtime مرورگر و ابزارهای کاراکتر',
    'home.intro':
      'جلسه‌ها را اجرا کنید، کاراکترها را مدیریت کنید و tabletop زنده را از یک محیط کاری کاربردی ببینید. بخش مورد نیازتان را انتخاب کنید و ادامه دهید.',
    ...
    'runtime.summary':
      'یک سطح مرورگری role-aware برای بک‌اند فعلی. حقیقت همچنان دست سرور است؛ SSE فقط زنده است و بازیابی، وضعیت را از read modelها بازسازی می‌کند.',
    'runtime.title': 'میز نبرد Runtime',
    'shell.builderMvp.body':
      'ورودی‌های کتابخانه کاراکتر با مالکیت dev قبل از auth ذخیره می‌شوند. auth تولیدی و مالکیت حساب عمدا هنوز pending است.',
    'shell.builderMvp.title': 'MVP سازنده',
