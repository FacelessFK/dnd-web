...
/**
 * Exported so tests can assert that a descriptor's key actually resolves in
 * both locales. `type Messages = typeof messages.en` already makes a missing
 * `fa` key a type error; what it cannot catch is a key emitted at runtime that
...
export const messages = {
  en: {
    ...
    'home.card.maps.description':
      'Paint terrain, place props, and publish playable maps.',
    'home.card.maps.title': 'Map Builder',
    ...
    'maps.blocksMovement': 'Blocks movement',
    'maps.blocksVision': 'Blocks vision',
    'maps.brushSize': 'Brush size: {size}',
    'maps.cursor': '{x}, {y} · {tile}',
    'maps.entities': 'Props',
    'maps.entity.crate': 'Crate',
    'maps.entity.decor': 'Decor',
    'maps.entity.monster': 'Monster marker',
    'maps.entity.pillar': 'Pillar',
    'maps.entity.spawn': 'Player spawn',
    'maps.entityHint': 'Click to place · shift-click to remove',
    'maps.entityName': 'Prop name',
    'maps.export': 'Export',
    'maps.height': 'H',
    'maps.hidden': 'Hidden from players',
    'maps.hint':
      'Paint with the left button · right-drag to pan · scroll to zoom',
    'maps.import': 'Import',
    'maps.inspector': 'Selected prop',
    'maps.mapName': 'Map name',
    'maps.newMap': 'New map',
    'maps.outlineOnly': 'Outline only',
    'maps.preset.trainingRoom': 'Training Room',
    'maps.publish': 'Publish to table',
    'maps.publish.done':
      'Published as scene {sceneId}. Activate it from the runtime table.',
    'maps.publish.failed': 'The server did not return a scene.',
    'maps.publish.noSession':
      'Open the runtime table and create a session first.',
    'maps.publish.working': 'Publishing map…',
    'maps.removeEntity': 'Remove prop',
    'maps.redo': 'Redo',
    'maps.tile.chasm': 'Chasm',
    'maps.tile.deep_water': 'Deep water',
    'maps.tile.dirt': 'Dirt',
    'maps.tile.flagstone': 'Flagstone',
    'maps.tile.grass': 'Grass',
    'maps.tile.ice': 'Ice',
    'maps.tile.lava': 'Lava',
    'maps.tile.rubble': 'Rubble',
    'maps.tile.sand': 'Sand',
    'maps.tile.stone': 'Stone',
    'maps.tile.void': 'Void',
    'maps.tile.wall': 'Wall',
    'maps.tile.wall_brick': 'Brick wall',
    'maps.tile.water': 'Water',
    'maps.tile.wood': 'Wood',
    'maps.tiles': 'Terrain',
    'maps.title': 'Map Builder',
    'maps.tool.brush': 'Brush',
    'maps.tool.entity': 'Props',
    'maps.tool.eraser': 'Eraser',
    'maps.tool.fill': 'Fill',
    'maps.tool.line': 'Line',
    'maps.tool.rectangle': 'Rectangle',
    'maps.tool.select': 'Select',
    'maps.tools': 'Tools',
    'maps.undo': 'Undo',
    'maps.width': 'W',
    ...
    'runtime.map.cursor': 'Cell {x}, {y}',
    'runtime.map.fit': 'Fit',
    'runtime.map.gridSummary': '{width} × {height} grid',
    'runtime.map.hint': 'Drag to pan · scroll to zoom · click to select',
    'runtime.map.label': 'Tactical map',
    'runtime.map.noScene': 'No active scene',
    ...
    'runtime.characterSheet.abilities': 'Abilities',
    'runtime.characterSheet.background': 'Background',
    'runtime.characterSheet.className': 'Class',
    'runtime.characterSheet.combatBasics': 'Combat basics',
    'runtime.characterSheet.createDraft': 'Create Draft',
    'runtime.characterSheet.description':
      'Create and maintain your own character draft. The server validates and returns the authoritative sheet.',
    'runtime.characterSheet.draftNotCreated': 'Draft not created yet',
    'runtime.characterSheet.eyebrow': 'Character sheet',
    'runtime.characterSheet.finalize': 'Finalize',
    'runtime.characterSheet.level': 'Level (create only)',
    'runtime.characterSheet.name': 'Name',
    'runtime.characterSheet.needsAttention': 'Sheet needs attention',
    'runtime.characterSheet.notes': 'Notes',
    'runtime.characterSheet.species': 'Species/Race',
    'runtime.characterSheet.submitToDm': 'Submit to DM',
    'runtime.characterSheet.title': 'Player Character',
    'runtime.characterSheet.unnamed': 'Unwritten adventurer',
    'runtime.characterSheet.updateDraft': 'Update Draft',
    ...
    'runtime.recoveryNote.activeScene': 'No map is active at this table yet.',
    'runtime.recoveryNote.character':
      'A character could not be restored; ask the GM to reassign it.',
    'runtime.recoveryNote.encounter': 'This table has no encounter yet.',
    'runtime.recoveryNote.generic':
      'Part of the table could not be restored yet.',
    'runtime.recoveryNote.scene': 'The map could not be restored yet.',
    ...
    'runtime.m1.feedback.hit': 'Hit for {damage}',
    'runtime.m1.feedback.criticalHit': 'Critical hit for {damage}',
    'runtime.m1.feedback.miss': 'Missed',
    'runtime.m1.feedback.criticalMiss': 'Critical miss',
    'runtime.m1.feedback.turnChanged': 'Turn advanced — round {round}',
    'runtime.m1.feedback.visibilityChanged': 'The GM changed what is visible',
    'runtime.m1.feedback.resolutionRequested': 'The GM asked for a roll',
    'runtime.m1.feedback.resolutionCancelled': 'The GM withdrew a request',
    'runtime.m1.feedback.resolutionSubmitted': 'Rolled {total}',
    'runtime.m1.feedback.resolutionSuccess': 'Success with {total}',
    'runtime.m1.feedback.resolutionFailure': 'Failed with {total}',
    'runtime.m1.feedback.intentSubmitted': 'A note reached the GM',
    'runtime.m1.feedback.intentStatusChanged': 'A note is now {statusKey}',
    'runtime.m1.status.connected': 'Live',
    'runtime.m1.status.disconnected': 'Disconnected',
    'runtime.m1.status.reconnecting': 'Reconnecting…',
    'runtime.m1.status.recovered': 'Recovered',
    'runtime.m1.gm.title': 'Ask for a roll',
    'runtime.m1.gm.target': 'Who rolls',
    'runtime.m1.gm.kind': 'What kind',
    'runtime.m1.gm.ability': 'Ability',
    'runtime.m1.gm.skill': 'Skill',
    'runtime.m1.gm.skillNone': 'No skill',
    'runtime.m1.gm.dc': 'DC',
    'runtime.m1.gm.stance': 'Stance',
    'runtime.m1.gm.reason': 'Why (optional)',
    'runtime.m1.gm.submit': 'Send request',
    'runtime.m1.gm.submitting': 'Sending…',
    'runtime.m1.gm.cancel': 'Withdraw',
    'runtime.m1.gm.noTargets': 'No seat has a runtime character yet.',
    'runtime.m1.gm.requests': 'Requests',
    'runtime.m1.gm.noRequests': 'Nothing asked for yet.',
    'runtime.m1.gm.applyPoisoned': 'Apply poisoned',
    'runtime.m1.gm.removePoisoned': 'Remove poisoned',
    'runtime.m1.gm.conditions': 'Conditions',
    'runtime.m1.gm.conditionNone': 'No conditions',
    'runtime.m1.gm.visibility': 'Creature visibility',
    'runtime.m1.gm.conceal': 'Conceal',
    'runtime.m1.gm.reveal': 'Reveal',
    'runtime.m1.gm.concealed': 'Concealed',
    'runtime.m1.gm.visible': 'Visible',
    'runtime.m1.gm.noCombatants': 'No creatures on the map.',
    'runtime.m1.gm.intents': 'Table notes',
    'runtime.m1.gm.noIntents': 'No notes yet.',
    'runtime.m1.gm.acknowledge': 'Mark seen',
    'runtime.m1.gm.resolve': 'Resolve',
    'runtime.m1.gm.dismiss': 'Dismiss',
    'runtime.m1.player.title': 'Your rolls',
    'runtime.m1.player.pending': 'The GM is waiting on you',
    'runtime.m1.player.roll': 'Roll it',
    'runtime.m1.player.rolling': 'Rolling…',
    'runtime.m1.player.noPending': 'Nothing to roll right now.',
    'runtime.m1.player.recent': 'Recent rolls',
    'runtime.m1.player.noRecent': 'No rolls yet.',
    'runtime.m1.player.intentTitle': 'Tell the GM what you want to do',
    'runtime.m1.player.intentPlaceholder': 'One short sentence',
    'runtime.m1.player.intentSubmit': 'Send to the GM',
    'runtime.m1.player.intentSending': 'Sending…',
    'runtime.m1.player.intents': 'Your notes',
    'runtime.m1.player.noIntents': 'No notes yet.',
    'runtime.m1.player.conditions': 'Your condition',
    'runtime.m1.result.dice': 'Dice',
    'runtime.m1.result.selected': 'Kept',
    'runtime.m1.result.total': 'Total',
    'runtime.m1.result.modifiers': 'Modifiers',
    'runtime.m1.result.why': 'Why',
    'runtime.m1.result.noResult': 'Not rolled yet.',
    'runtime.m1.ability.str': 'Strength',
    'runtime.m1.ability.dex': 'Dexterity',
    'runtime.m1.ability.con': 'Constitution',
    'runtime.m1.ability.int': 'Intelligence',
    'runtime.m1.ability.wis': 'Wisdom',
    'runtime.m1.ability.cha': 'Charisma',
    'runtime.m1.skill.acrobatics': 'Acrobatics',
    'runtime.m1.skill.animal-handling': 'Animal Handling',
    'runtime.m1.skill.arcana': 'Arcana',
    'runtime.m1.skill.athletics': 'Athletics',
    'runtime.m1.skill.deception': 'Deception',
    'runtime.m1.skill.history': 'History',
    'runtime.m1.skill.insight': 'Insight',
    'runtime.m1.skill.intimidation': 'Intimidation',
    'runtime.m1.skill.investigation': 'Investigation',
    'runtime.m1.skill.medicine': 'Medicine',
    'runtime.m1.skill.nature': 'Nature',
    'runtime.m1.skill.perception': 'Perception',
    'runtime.m1.skill.performance': 'Performance',
    'runtime.m1.skill.persuasion': 'Persuasion',
    'runtime.m1.skill.religion': 'Religion',
    'runtime.m1.skill.sleight-of-hand': 'Sleight of Hand',
    'runtime.m1.skill.stealth': 'Stealth',
    'runtime.m1.skill.survival': 'Survival',
    'runtime.m1.stance.normal': 'Normal',
    'runtime.m1.stance.advantage': 'Advantage',
    'runtime.m1.stance.disadvantage': 'Disadvantage',
    'runtime.m1.kind.ability_check': 'Ability check',
    'runtime.m1.kind.saving_throw': 'Saving throw',
    'runtime.m1.kind.attack_roll': 'Attack roll',
    'runtime.m1.requestStatus.pending': 'Awaiting a roll',
    'runtime.m1.requestStatus.resolved': 'Resolved',
    'runtime.m1.requestStatus.cancelled': 'Withdrawn',
    'runtime.m1.intentStatus.pending': 'Waiting on the GM',
    'runtime.m1.intentStatus.acknowledged': 'Seen by the GM',
    'runtime.m1.intentStatus.resolved': 'Resolved',
    'runtime.m1.intentStatus.dismissed': 'Dismissed',
    'runtime.m1.modifier.ability': '{abilityKey} modifier',
    'runtime.m1.modifier.proficiency': 'Proficiency bonus',
    'runtime.m1.modifier.proficiencySkill': 'Proficiency bonus ({skillKey})',
    'runtime.m1.modifier.condition': '{conditionKey}',
    'runtime.m1.modifier.gmAdjustment': 'GM adjustment',
    'runtime.m1.stanceSource.condition': '{conditionKey} gives {stanceKey}',
    'runtime.m1.stanceSource.gmRequest': 'The GM asked for {stanceKey}',
    'runtime.m1.threshold.dc': 'DC',
    'runtime.m1.threshold.ac': 'AC',
    'runtime.m1.outcome.success': 'Success',
    'runtime.m1.outcome.failure': 'Failure',
    'runtime.m1.outcome.hit': 'Hit',
    'runtime.m1.outcome.miss': 'Miss',
    'runtime.m1.condition.poisoned': 'Poisoned',
    'runtime.m1.condition.poisonedEffect':
      'Disadvantage on attack rolls and ability checks. Saving throws are unaffected.',
    'runtime.m1.error.requestNotFound':
      'That request is no longer on the table.',
    'runtime.m1.error.requestAlreadyResolved':
      'That request has already been answered.',
    'runtime.m1.error.notYourRequest':
      'That request was addressed to another seat.',
    'runtime.m1.error.intentNotFound': 'That note is no longer on the table.',
    'runtime.m1.error.intentAlreadyDecided':
      'The GM has already decided that note.',
    'runtime.m1.error.commandConflict':
      'That action was already sent with different details. Try again.',
    'runtime.m1.error.notAllowed': 'Only the GM can do that.',
    'runtime.m1.error.seatOwned': 'That seat belongs to another account.',
    'runtime.m1.error.credentialExpired':
      'Your seat needs to be reclaimed. Reconnect to continue.',
    'runtime.m1.error.noAssignedCharacter':
      'No character is assigned to that seat yet.',
    'runtime.m1.error.noActiveScene': 'No map is active yet.',
    'runtime.m1.error.noActiveEncounter': 'No encounter is running.',
    'runtime.m1.error.combatantNotFound': 'That creature is not on the map.',
    'runtime.m1.error.generic': 'The server refused that action.',
    'runtime.connection.idle': 'Not connected',
    'runtime.connection.connecting': 'Connecting',
    'runtime.connection.connected': 'Live',
    'runtime.connection.reconnecting': 'Reconnecting',
    'runtime.connection.credentialInvalid': 'Sign in again to rejoin',
    'runtime.connection.seatUnavailable': 'This seat is not available',
    ...
    // The 2014 condition vocabulary. Protocol values, so they are translated;
    // anything a GM typed themselves is authored content and passes through.
    'runtime.condition.blinded': 'Blinded',
    'runtime.condition.charmed': 'Charmed',
    'runtime.condition.deafened': 'Deafened',
    'runtime.condition.exhaustion': 'Exhaustion',
    'runtime.condition.frightened': 'Frightened',
    'runtime.condition.grappled': 'Grappled',
    'runtime.condition.incapacitated': 'Incapacitated',
    'runtime.condition.invisible': 'Invisible',
    'runtime.condition.paralyzed': 'Paralyzed',
    'runtime.condition.petrified': 'Petrified',
    'runtime.condition.poisoned': 'Poisoned',
    'runtime.condition.prone': 'Prone',
    'runtime.condition.restrained': 'Restrained',
    'runtime.condition.stunned': 'Stunned',
    'runtime.condition.unconscious': 'Unconscious',
    'runtime.condition.unknown': 'An unknown condition',
    'runtime.condition.separator': ', ',
  ...
  fa: {
    ...
    'home.card.maps.description':
      'زمین را نقاشی کنید، اشیاء بگذارید و نقشه‌های قابل بازی منتشر کنید.',
    'home.card.maps.title': 'نقشه‌ساز',
    'home.card.runtime.description':
    ...
    'maps.blocksMovement': 'مانع حرکت',
    'maps.blocksVision': 'مانع دید',
    'maps.brushSize': 'اندازه قلم: {size}',
    'maps.cursor': '{x}، {y} · {tile}',
    'maps.entities': 'اشیاء',
    'maps.entity.crate': 'جعبه',
    'maps.entity.decor': 'تزئینات',
    'maps.entity.monster': 'نشانه هیولا',
    'maps.entity.pillar': 'ستون',
    'maps.entity.spawn': 'نقطه ورود بازیکن',
    'maps.entityHint': 'برای قرار دادن کلیک کنید · با shift+کلیک حذف کنید',
    'maps.entityName': 'نام شیء',
    'maps.export': 'خروجی',
    'maps.height': 'ا',
    'maps.hidden': 'پنهان از بازیکنان',
    'maps.hint':
      'با دکمه چپ بکشید · با دکمه راست جابه‌جا کنید · با اسکرول زوم کنید',
    'maps.import': 'ورودی',
    'maps.inspector': 'شیء انتخاب‌شده',
    'maps.mapName': 'نام نقشه',
    'maps.newMap': 'نقشه جدید',
    'maps.outlineOnly': 'فقط دورخط',
    'maps.preset.trainingRoom': 'اتاق تمرین',
    'maps.publish': 'انتشار روی میز',
    'maps.publish.done':
      'به عنوان صحنه {sceneId} منتشر شد. آن را از میز اجرا فعال کنید.',
    'maps.publish.failed': 'سرور صحنه‌ای برنگرداند.',
    'maps.publish.noSession': 'ابتدا میز اجرا را باز کنید و یک نشست بسازید.',
    'maps.publish.working': 'در حال انتشار نقشه…',
    'maps.removeEntity': 'حذف شیء',
    'maps.redo': 'بازانجام',
    'maps.tile.chasm': 'شکاف',
    'maps.tile.deep_water': 'آب عمیق',
    'maps.tile.dirt': 'خاک',
    'maps.tile.flagstone': 'سنگ‌فرش',
    'maps.tile.grass': 'چمن',
    'maps.tile.ice': 'یخ',
    'maps.tile.lava': 'گدازه',
    'maps.tile.rubble': 'آوار',
    'maps.tile.sand': 'شن',
    'maps.tile.stone': 'سنگ',
    'maps.tile.void': 'تهی',
    'maps.tile.wall': 'دیوار',
    'maps.tile.wall_brick': 'دیوار آجری',
    'maps.tile.water': 'آب',
    'maps.tile.wood': 'چوب',
    'maps.tiles': 'زمین',
    'maps.title': 'نقشه‌ساز',
    'maps.tool.brush': 'قلم',
    'maps.tool.entity': 'اشیاء',
    'maps.tool.eraser': 'پاک‌کن',
    'maps.tool.fill': 'پرکردن',
    'maps.tool.line': 'خط',
    'maps.tool.rectangle': 'مستطیل',
    'maps.tool.select': 'انتخاب',
    'maps.tools': 'ابزارها',
    'maps.undo': 'واگرد',
    'maps.width': 'ط',
    ...
    'runtime.map.cursor': 'خانه {x}، {y}',
    'runtime.map.fit': 'اندازه',
    'runtime.map.gridSummary': 'شبکه {width} × {height}',
    'runtime.map.hint':
      'برای جابه‌جایی بکشید · با اسکرول زوم کنید · برای انتخاب کلیک کنید',
    'runtime.map.label': 'نقشه تاکتیکی',
    'runtime.map.noScene': 'صحنه فعالی نیست',
    'runtime.characterLibrary.blocker.alreadyAssigned':
    ...
    'runtime.characterSheet.abilities': 'توانایی‌ها',
    'runtime.characterSheet.background': 'پیشینه',
    'runtime.characterSheet.className': 'کلاس',
    'runtime.characterSheet.combatBasics': 'پایه‌های مبارزه',
    'runtime.characterSheet.createDraft': 'ساخت پیش‌نویس',
    'runtime.characterSheet.description':
      'پیش‌نویس شخصیت خود را بسازید و نگه دارید. سرور آن را اعتبارسنجی می‌کند و برگه معتبر را بازمی‌گرداند.',
    'runtime.characterSheet.draftNotCreated': 'هنوز پیش‌نویسی ساخته نشده',
    'runtime.characterSheet.eyebrow': 'برگه شخصیت',
    'runtime.characterSheet.finalize': 'نهایی‌سازی',
    'runtime.characterSheet.level': 'سطح (فقط هنگام ساخت)',
    'runtime.characterSheet.name': 'نام',
    'runtime.characterSheet.needsAttention': 'برگه نیاز به اصلاح دارد',
    'runtime.characterSheet.notes': 'یادداشت‌ها',
    'runtime.characterSheet.species': 'گونه/نژاد',
    'runtime.characterSheet.submitToDm': 'ارسال به DM',
    'runtime.characterSheet.title': 'شخصیت بازیکن',
    'runtime.characterSheet.unnamed': 'ماجراجوی بی‌نام',
    'runtime.characterSheet.updateDraft': 'به‌روزرسانی پیش‌نویس',
    ...
    'runtime.recoveryNote.activeScene': 'هنوز نقشه‌ای در این میز فعال نیست.',
    'runtime.recoveryNote.character':
      'یک شخصیت بازیابی نشد؛ از GM بخواهید دوباره آن را تخصیص دهد.',
    'runtime.recoveryNote.encounter': 'این میز هنوز برخوردی ندارد.',
    'runtime.recoveryNote.generic': 'بخشی از میز هنوز بازیابی نشد.',
    'runtime.recoveryNote.scene': 'نقشه هنوز بازیابی نشد.',
    ...
    'runtime.m1.feedback.hit': 'اصابت با {damage} آسیب',
    'runtime.m1.feedback.criticalHit': 'اصابت مهلک با {damage} آسیب',
    'runtime.m1.feedback.miss': 'خطا رفت',
    'runtime.m1.feedback.criticalMiss': 'خطای مهلک',
    'runtime.m1.feedback.turnChanged': 'نوبت پیش رفت — دور {round}',
    'runtime.m1.feedback.visibilityChanged':
      'راوی آنچه دیده می‌شود را تغییر داد',
    'runtime.m1.feedback.resolutionRequested': 'راوی یک پرتاب خواست',
    'runtime.m1.feedback.resolutionCancelled': 'راوی درخواست را پس گرفت',
    'runtime.m1.feedback.resolutionSubmitted': 'پرتاب {total}',
    'runtime.m1.feedback.resolutionSuccess': 'موفق با {total}',
    'runtime.m1.feedback.resolutionFailure': 'ناموفق با {total}',
    'runtime.m1.feedback.intentSubmitted': 'یادداشتی به راوی رسید',
    'runtime.m1.feedback.intentStatusChanged':
      'وضعیت یادداشت اکنون {statusKey} است',
    'runtime.m1.status.connected': 'زنده',
    'runtime.m1.status.disconnected': 'قطع',
    'runtime.m1.status.reconnecting': 'در حال اتصال دوباره…',
    'runtime.m1.status.recovered': 'بازیابی شد',
    'runtime.m1.gm.title': 'درخواست پرتاب',
    'runtime.m1.gm.target': 'چه کسی پرتاب کند',
    'runtime.m1.gm.kind': 'چه نوعی',
    'runtime.m1.gm.ability': 'توانایی',
    'runtime.m1.gm.skill': 'مهارت',
    'runtime.m1.gm.skillNone': 'بدون مهارت',
    'runtime.m1.gm.dc': 'درجه دشواری',
    'runtime.m1.gm.stance': 'حالت',
    'runtime.m1.gm.reason': 'چرا (اختیاری)',
    'runtime.m1.gm.submit': 'ارسال درخواست',
    'runtime.m1.gm.submitting': 'در حال ارسال…',
    'runtime.m1.gm.cancel': 'پس گرفتن',
    'runtime.m1.gm.noTargets': 'هنوز هیچ جایگاهی شخصیت اجرایی ندارد.',
    'runtime.m1.gm.requests': 'درخواست‌ها',
    'runtime.m1.gm.noRequests': 'هنوز چیزی خواسته نشده است.',
    'runtime.m1.gm.applyPoisoned': 'اعمال مسمومیت',
    'runtime.m1.gm.removePoisoned': 'برداشتن مسمومیت',
    'runtime.m1.gm.conditions': 'وضعیت‌ها',
    'runtime.m1.gm.conditionNone': 'بدون وضعیت',
    'runtime.m1.gm.visibility': 'دیده‌شدن موجودات',
    'runtime.m1.gm.conceal': 'پنهان کردن',
    'runtime.m1.gm.reveal': 'آشکار کردن',
    'runtime.m1.gm.concealed': 'پنهان',
    'runtime.m1.gm.visible': 'آشکار',
    'runtime.m1.gm.noCombatants': 'موجودی روی نقشه نیست.',
    'runtime.m1.gm.intents': 'یادداشت‌های میز',
    'runtime.m1.gm.noIntents': 'هنوز یادداشتی نیست.',
    'runtime.m1.gm.acknowledge': 'دیده شد',
    'runtime.m1.gm.resolve': 'حل شد',
    'runtime.m1.gm.dismiss': 'رد',
    'runtime.m1.player.title': 'پرتاب‌های شما',
    'runtime.m1.player.pending': 'راوی منتظر شماست',
    'runtime.m1.player.roll': 'پرتاب کن',
    'runtime.m1.player.rolling': 'در حال پرتاب…',
    'runtime.m1.player.noPending': 'اکنون چیزی برای پرتاب نیست.',
    'runtime.m1.player.recent': 'پرتاب‌های اخیر',
    'runtime.m1.player.noRecent': 'هنوز پرتابی نیست.',
    'runtime.m1.player.intentTitle': 'به راوی بگویید می‌خواهید چه کنید',
    'runtime.m1.player.intentPlaceholder': 'یک جمله کوتاه',
    'runtime.m1.player.intentSubmit': 'ارسال به راوی',
    'runtime.m1.player.intentSending': 'در حال ارسال…',
    'runtime.m1.player.intents': 'یادداشت‌های شما',
    'runtime.m1.player.noIntents': 'هنوز یادداشتی نیست.',
    'runtime.m1.player.conditions': 'وضعیت شما',
    'runtime.m1.result.dice': 'تاس‌ها',
    'runtime.m1.result.selected': 'نگه‌داشته',
    'runtime.m1.result.total': 'مجموع',
    'runtime.m1.result.modifiers': 'اصلاح‌گرها',
    'runtime.m1.result.why': 'چرا',
    'runtime.m1.result.noResult': 'هنوز پرتاب نشده است.',
    'runtime.m1.ability.str': 'قدرت',
    'runtime.m1.ability.dex': 'چابکی',
    'runtime.m1.ability.con': 'بنیه',
    'runtime.m1.ability.int': 'هوش',
    'runtime.m1.ability.wis': 'خرد',
    'runtime.m1.ability.cha': 'جذبه',
    'runtime.m1.skill.acrobatics': 'آکروبات',
    'runtime.m1.skill.animal-handling': 'رام‌کردن جانوران',
    'runtime.m1.skill.arcana': 'رمزدانی',
    'runtime.m1.skill.athletics': 'ورزیدگی',
    'runtime.m1.skill.deception': 'فریب',
    'runtime.m1.skill.history': 'تاریخ',
    'runtime.m1.skill.insight': 'بصیرت',
    'runtime.m1.skill.intimidation': 'ارعاب',
    'runtime.m1.skill.investigation': 'کاوش',
    'runtime.m1.skill.medicine': 'پزشکی',
    'runtime.m1.skill.nature': 'طبیعت',
    'runtime.m1.skill.perception': 'ادراک',
    'runtime.m1.skill.performance': 'هنرنمایی',
    'runtime.m1.skill.persuasion': 'ترغیب',
    'runtime.m1.skill.religion': 'دین',
    'runtime.m1.skill.sleight-of-hand': 'تردستی',
    'runtime.m1.skill.stealth': 'پنهان‌کاری',
    'runtime.m1.skill.survival': 'بقا',
    'runtime.m1.stance.normal': 'عادی',
    'runtime.m1.stance.advantage': 'برتری',
    'runtime.m1.stance.disadvantage': 'کاستی',
    'runtime.m1.kind.ability_check': 'آزمون توانایی',
    'runtime.m1.kind.saving_throw': 'پرتاب نجات',
    'runtime.m1.kind.attack_roll': 'پرتاب حمله',
    'runtime.m1.requestStatus.pending': 'در انتظار پرتاب',
    'runtime.m1.requestStatus.resolved': 'پاسخ داده شد',
    'runtime.m1.requestStatus.cancelled': 'پس گرفته شد',
    'runtime.m1.intentStatus.pending': 'در انتظار راوی',
    'runtime.m1.intentStatus.acknowledged': 'راوی دید',
    'runtime.m1.intentStatus.resolved': 'حل شد',
    'runtime.m1.intentStatus.dismissed': 'رد شد',
    'runtime.m1.modifier.ability': 'اصلاح‌گر {abilityKey}',
    'runtime.m1.modifier.proficiency': 'پاداش مهارت',
    'runtime.m1.modifier.proficiencySkill': 'پاداش مهارت ({skillKey})',
    'runtime.m1.modifier.condition': '{conditionKey}',
    'runtime.m1.modifier.gmAdjustment': 'تنظیم راوی',
    'runtime.m1.stanceSource.condition':
      '{conditionKey} باعث {stanceKey} می‌شود',
    'runtime.m1.stanceSource.gmRequest': 'راوی {stanceKey} خواست',
    'runtime.m1.threshold.dc': 'درجه دشواری',
    'runtime.m1.threshold.ac': 'کلاس زره',
    'runtime.m1.outcome.success': 'موفق',
    'runtime.m1.outcome.failure': 'ناموفق',
    'runtime.m1.outcome.hit': 'اصابت',
    'runtime.m1.outcome.miss': 'خطا',
    'runtime.m1.condition.poisoned': 'مسموم',
    'runtime.m1.condition.poisonedEffect':
      'کاستی روی پرتاب حمله و آزمون توانایی. پرتاب نجات تحت تأثیر نیست.',
    'runtime.m1.error.requestNotFound': 'این درخواست دیگر روی میز نیست.',
    'runtime.m1.error.requestAlreadyResolved':
      'به این درخواست قبلاً پاسخ داده شده است.',
    'runtime.m1.error.notYourRequest': 'این درخواست برای جایگاه دیگری بود.',
    'runtime.m1.error.intentNotFound': 'این یادداشت دیگر روی میز نیست.',
    'runtime.m1.error.intentAlreadyDecided':
      'راوی پیش‌تر درباره این یادداشت تصمیم گرفته است.',
    'runtime.m1.error.commandConflict':
      'این کنش پیش‌تر با جزئیات دیگری فرستاده شده بود. دوباره تلاش کنید.',
    'runtime.m1.error.notAllowed': 'فقط راوی می‌تواند این کار را انجام دهد.',
    'runtime.m1.error.seatOwned': 'این جایگاه به حساب دیگری تعلق دارد.',
    'runtime.m1.error.credentialExpired':
      'جایگاه شما باید دوباره گرفته شود. برای ادامه دوباره وصل شوید.',
    'runtime.m1.error.noAssignedCharacter':
      'هنوز شخصیتی به این جایگاه اختصاص نیافته است.',
    'runtime.m1.error.noActiveScene': 'هنوز نقشه‌ای فعال نیست.',
    'runtime.m1.error.noActiveEncounter': 'نبردی در جریان نیست.',
    'runtime.m1.error.combatantNotFound': 'این موجود روی نقشه نیست.',
    'runtime.m1.error.generic': 'سرور این کنش را نپذیرفت.',
    'runtime.connection.idle': 'متصل نیست',
    'runtime.connection.connecting': 'در حال اتصال',
    'runtime.connection.connected': 'زنده',
    'runtime.connection.reconnecting': 'در حال اتصال دوباره',
    'runtime.connection.credentialInvalid': 'برای بازگشت دوباره وارد شوید',
    'runtime.connection.seatUnavailable': 'این جایگاه در دسترس نیست',
    ...
    'runtime.condition.blinded': 'کور',
    'runtime.condition.charmed': 'افسون‌شده',
    'runtime.condition.deafened': 'ناشنوا',
    'runtime.condition.exhaustion': 'خستگی',
    'runtime.condition.frightened': 'ترسیده',
    'runtime.condition.grappled': 'گرفتار',
    'runtime.condition.incapacitated': 'ناتوان',
    'runtime.condition.invisible': 'نامرئی',
    'runtime.condition.paralyzed': 'فلج',
    'runtime.condition.petrified': 'سنگ‌شده',
    'runtime.condition.poisoned': 'مسموم',
    'runtime.condition.prone': 'افتاده',
    'runtime.condition.restrained': 'مهارشده',
    'runtime.condition.stunned': 'مبهوت',
    'runtime.condition.unconscious': 'بیهوش',
    'runtime.condition.unknown': 'وضعیت نامشخص',
    // The Arabic comma, not the Latin one: joining with ', ' is the other half
    // of what made these lists read as English inside an RTL layout.
    'runtime.condition.separator': '، ',
