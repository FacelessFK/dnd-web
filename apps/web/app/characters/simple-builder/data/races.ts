...
export const RACES: Race[] = [
  {
    ...
    imageUrl: dicebear('human-warrior'),
    speed: 30,
    size: 'Medium',
  ...
  },
  {
    ...
    traits: [
      {
        name: 'Darkvision',
        description: 'Accustomed to twilit forests, you have superior vision in dark conditions up to 60 feet.',
      },
      {
        name: 'Keen Senses',
    ...
    subraces: [
      {
        ...
        traits: [
          ...
          {
            name: 'Cantrip',
            description: 'You know one cantrip of your choice from the wizard spell list (INT is your spellcasting ability).',
          },
          {
            name: 'Extra Language',
      ...
      },
      {
        ...
        traits: [
          ...
          },
          {
            ...
            description: 'You can attempt to hide even when only lightly obscured by foliage, rain, snow, or mist.',
          },
        ],
      },
      {
        ...
        traits: [
          ...
          {
            name: 'Drow Magic',
            description: 'You know the Dancing Lights cantrip. At 3rd level, you can cast Faerie Fire once per day.',
          },
          {
  ...
  },
  {
    ...
    imageUrl: dicebear('half-elf-charming'),
    speed: 30,
    size: 'Medium',
    asi: { CHA: 2 },
  ...
  },
  {
    ...
    traits: [
      ...
      },
      {
        ...
        description: 'You gain proficiency with the artisan\'s tools of your choice: smith\'s, brewer\'s, or mason\'s tools.',
      },
      {
        name: 'Stonecunning',
        description: 'You have advantage on History checks related to the origin of stonework.',
      },
    ],
    subraces: [
      {
  ...
  },
  {
    ...
    imageUrl: dicebear('halfling-lucky'),
    speed: 25,
    size: 'Small',
    asi: { DEX: 2 },
    ...
    traits: [
      {
        name: 'Lucky',
        description: 'When you roll a 1 on a d20 for an attack roll, ability check, or saving throw, you can reroll and must use the new roll.',
      },
      {
        name: 'Brave',
  ...
  },
  {
    ...
    imageUrl: dicebear('gnome-inventor'),
    speed: 25,
    size: 'Small',
    asi: { INT: 2 },
    ...
    subraces: [
      {
        ...
        traits: [
          ...
          },
          {
            ...
            description: 'Through sounds and gestures, you can communicate simple ideas to Small or smaller beasts.',
          },
        ],
      },
      {
        ...
        traits: [
          ...
          {
            name: 'Tinker',
            description: 'You have proficiency with artisan\'s tools (tinker\'s tools). You can spend 1 hour to construct a Tiny clockwork device.',
          },
        ],
      },
    ],
  },
  {
    ...
    imageUrl: dicebear('halforc-fierce'),
    speed: 30,
    size: 'Medium',
    asi: { STR: 2, CON: 1 },
  ...
  },
  {
    ...
    imageUrl: dicebear('tiefling-infernal'),
    speed: 30,
    size: 'Medium',
    asi: { INT: 1, CHA: 2 },
  ...
  },
  {
    ...
    imageUrl: dicebear('dragonborn-scaled'),
    speed: 30,
    size: 'Medium',
    asi: { STR: 2, CHA: 1 },
    ...
    traits: [
      {
        ...
        description: 'You have draconic ancestry of a chosen dragon type, which determines your breath weapon and damage resistance. Common choices: Black (acid), Blue (lightning), Red (fire), White (cold), Green (poison).',
      },
      {
        name: 'Breath Weapon',
        description: 'You can use your action to exhale destructive energy. Your draconic ancestry determines the size, shape, and damage type of the exhalation. Recharges on short or long rest.',
      },
      {
