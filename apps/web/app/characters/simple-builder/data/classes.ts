...
export const CLASSES: DnDClass[] = [
  {
    ...
    imageUrl: classImage('barbarian'),
    symbolUrl: classSymbol('barbarian'),
    hitDie: 12,
  ...
  },
  {
    ...
    imageUrl: classImage('bard'),
    symbolUrl: classSymbol('bard'),
    hitDie: 8,
  ...
  },
  {
    ...
    imageUrl: classImage('cleric'),
    symbolUrl: classSymbol('cleric'),
    hitDie: 8,
  ...
  },
  {
    ...
    equipmentChoices: [
      {
        id: 'druid-weapons',
        label: 'Starting weapon choice',
        required: true,
        options: [
          { id: 'scimitar', label: 'Scimitar', items: ['Scimitar'] },
          {
            id: 'club-quarterstaff',
            label: 'Two simple weapons: club and quarterstaff',
            items: ['Club', 'Quarterstaff'],
          },
          {
            id: 'sickle-spear',
            label: 'Two simple weapons: sickle and spear',
            items: ['Sickle', 'Spear'],
          },
          {
            id: 'mace-sling',
            label: 'Two simple weapons: mace and sling',
            items: ['Mace', 'Sling'],
          },
        ],
      },
    ...
    spellcasting: {
      ...
      preparedSpells: ['Cure Wounds', 'Entangle', 'Faerie Fire'],
    },
  },
  {
    id: 'fighter',
    ...
    imageUrl: classImage('fighter'),
    symbolUrl: classSymbol('fighter'),
    hitDie: 10,
  ...
  },
  {
    ...
    imageUrl: classImage('monk'),
    symbolUrl: classSymbol('monk'),
    hitDie: 8,
  ...
  },
  {
    ...
    imageUrl: classImage('paladin'),
    symbolUrl: classSymbol('paladin'),
    hitDie: 10,
  ...
  },
  {
    ...
    imageUrl: classImage('ranger'),
    symbolUrl: classSymbol('ranger'),
    hitDie: 10,
    primaryAbility: 'Dexterity & Wisdom',
    savingThrows: ['STR', 'DEX'],
    armorProficiencies: ['Light armor', 'Medium armor', 'Shields'],
  ...
  },
  {
    ...
    imageUrl: classImage('rogue'),
    symbolUrl: classSymbol('rogue'),
    hitDie: 8,
  ...
  },
  {
    ...
    imageUrl: classImage('sorcerer'),
    symbolUrl: classSymbol('sorcerer'),
    hitDie: 6,
    primaryAbility: 'Charisma',
  ...
  },
  {
    ...
    imageUrl: classImage('warlock'),
    symbolUrl: classSymbol('warlock'),
    hitDie: 8,
    primaryAbility: 'Charisma',
    savingThrows: ['WIS', 'CHA'],
    armorProficiencies: ['Light armor'],
  ...
  },
  {
    ...
    imageUrl: classImage('wizard'),
    symbolUrl: classSymbol('wizard'),
    hitDie: 6,
