...
import type {
  ...
  SessionDiceResolutionRow,
  SessionDiceResolutionWrite,
  SessionPlayerIntentRow,
  SessionPlayerIntentWrite,
  SessionResolutionRequestRow,
  SessionResolutionRequestWrite,
  SessionSeatOwnershipDatabase,
  SessionSeatOwnershipRow,
  SessionSeatOwnershipWrite,
...
class EmptySessionSeatOwnershipDatabase implements SessionSeatOwnershipDatabase {
...
class EmptySessionTableStateDatabase implements SessionTableStateDatabase {
...
class StubUnitOfWork implements DndDatabaseUnitOfWork {
  async transaction<T>(
    ...
    return run({
      ...
      seatOwnership: new EmptySessionSeatOwnershipDatabase(),
      sessions: new EmptySessionSnapshotDatabase(),
      tableState: new EmptySessionTableStateDatabase(),
    });
  }
}
...
function createDbModeDependencies(params: {
  ...
  return {
    ...
    createSessionSeatOwnershipDatabase: () =>
      new EmptySessionSeatOwnershipDatabase(),
    createSessionTableStateDatabase: () => new EmptySessionTableStateDatabase(),
