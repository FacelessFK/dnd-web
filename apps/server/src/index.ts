...
server.listen(port, host, () => {
  console.log(
    `[server] Phase 12 session/character/movement/encounter/combat outbox foundation listening on http://${host}:${port}`,
  );
