> Archive/input material: this file preserves the handoff text that was used
> during documentation extraction. For current source-of-truth docs, read
> `docs/project-handoff.md`, `docs/engineering/CURRENT_STATE.md`,
> `docs/api-surface.md`, and `docs/persistence-boundaries.md`.

ببین فکر کن این ایده اصلی پروژ هست و بخش های زیادی از پروژه هم زده شده و فکر کن یه سازمان حرفه ای از دولوپر پروداکت و ... ما داریم که میخواییم این پروژه رو بسازیم که در سطح پروداکشن لول هست. برای شروع ما سیستم ساخت کاراکتر رو خیلی خوب ساختیم و یه mvp تمیز از این بخش داریم
اینم یه هند اف از پروژه هست :
...
حالا من میخوام برای ادامه این پروژه با این که دارم با ai پیش میبرم یعنی کدکس برام بزنه ولی میخوام تمام دیتاهایی که از اون brinstorm دراوردیم رو در اختیار دولوپر قرار بدم که بتونه ادامه بده میتونی بگی چطوری اینو پیش ببرم؟ یه تیم حرفه ای که میخواد یه پروژه high لول بسازه به چه دیتا هایی نیاز داره؟ باید براشون pdf اماده کنیم یاچی میخوام بدم codex برام کد بزنه ها
