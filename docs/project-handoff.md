...
compact scene entity presets, character placement/movement, local tactical
board camera controls, tactical board state badges, tactical board keyboard
navigation, mixed player/combatant encounters, turn usage, narrow melee attack
handling, readable event feed, a DM-facing Table Setup checklist, and DM
controls for HP, conditions, repositioning, combatants, current turn, turn
