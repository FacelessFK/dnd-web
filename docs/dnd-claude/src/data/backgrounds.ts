...
export const BACKGROUNDS: Background[] = [
  {
    ...
    imageUrl: dicebear('acolyte-temple'),
    skillProficiencies: ['Insight', 'Religion'],
    toolProficiencies: [],
    languages: 2,
    feature: {
      name: 'Shelter of the Faithful',
      description: 'As an acolyte, you command the respect of those who share your faith. You and your adventuring companions can expect to receive free healing and care at a temple, shrine, or other established presence of your faith.',
    },
  ...
  },
  {
    ...
    imageUrl: dicebear('charlatan-con'),
    skillProficiencies: ['Deception', 'Sleight of Hand'],
    toolProficiencies: ['Disguise kit', 'Forgery kit'],
    languages: 0,
    feature: {
      name: 'False Identity',
      description: 'You have created a second identity that includes documentation, established acquaintances, and disguises that allow you to assume that persona. You can also forge documents including official papers and personal letters.',
    },
    ...
    bonds: ['I fleeced the wrong person and must work to ensure they never find me.'],
  ...
  },
  {
    ...
    imageUrl: dicebear('criminal-outlaw'),
    skillProficiencies: ['Deception', 'Stealth'],
    toolProficiencies: ["Thieves' tools", 'One type of gaming set'],
    languages: 0,
    feature: {
      name: 'Criminal Contact',
      description: 'You have a reliable and trustworthy contact who acts as your liaison to a network of criminals. You know how to get messages to and from your contact, even over great distances.',
    },
  ...
  },
  {
    ...
    imageUrl: dicebear('entertainer-stage'),
    skillProficiencies: ['Acrobatics', 'Performance'],
    toolProficiencies: ['Disguise kit', 'One type of musical instrument'],
    languages: 0,
    feature: {
      name: 'By Popular Demand',
      description: 'You can always find a place to perform, usually in an inn or tavern but possibly with a circus, at a theatre, or even in a noble\'s court. Your performance makes you the equivalent of a local celebrity.',
    },
  ...
  },
  {
    ...
    imageUrl: dicebear('folk-hero-champion'),
  ...
  },
  {
    ...
    imageUrl: dicebear('guild-artisan-craft'),
    skillProficiencies: ['Insight', 'Persuasion'],
    toolProficiencies: ['One type of artisan\'s tools'],
    languages: 1,
    feature: {
      name: 'Guild Membership',
      description: 'As an established member of a guild, you can rely on certain benefits that membership provides. Fellow guild members will provide you with lodging and food if necessary, and pay for your funeral if needed.',
    },
  ...
  },
  {
    ...
    imageUrl: dicebear('hermit-secluded'),
    skillProficiencies: ['Medicine', 'Religion'],
    toolProficiencies: ['Herbalism kit'],
    languages: 1,
    feature: {
      name: 'Discovery',
      description: 'The quiet seclusion of your extended hermitage gave you access to a unique and powerful discovery. The exact nature of this revelation is up to you and the DM. It might be a great truth about the cosmos or the gods, or it could be a site that no one else has ever seen.',
    },
  ...
  },
  {
    ...
    imageUrl: dicebear('outlander-wild'),
    skillProficiencies: ['Athletics', 'Survival'],
    toolProficiencies: ['One type of musical instrument'],
    languages: 1,
    feature: {
      name: 'Wanderer',
      description: 'You have an excellent memory for maps and geography, and you can always recall the general layout of terrain, settlements, and other features around you. In addition, you can find food and fresh water for yourself and up to five other people each day.',
    },
  ...
  },
  {
    ...
    imageUrl: dicebear('sage-scholar'),
  ...
  },
  {
    ...
    equipment: ['Belaying pin (club)', '50 feet of silken rope', 'Lucky charm', 'Common clothes', '10 gp'],
    personalityTraits: [
  ...
  },
  {
    ...
    imageUrl: dicebear('soldier-veteran'),
