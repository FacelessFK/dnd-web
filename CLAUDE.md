...
not stat blocks; `get_scene`, encounter reads, and the encounter/combat streams
are role-projected so players never receive hidden entities or a concealed
combatant's identity; auth is an
